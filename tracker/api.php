<?php
// Pending-work tracker — JSON storage API
// GET  /api.php          → returns the current data array (JSON)
...
// Shared write token. Anyone with this can write — not real auth, just
// a barrier against random scanners. Change here AND in the HTML if rotating.
$TOKEN = 'oxEUCIkQZ1cAl3bmaDW7ryWSFVvixeiX';

$DATA_FILE = __DIR__ . '/pending-work-data.json';
...
if ($method === 'POST') {
    ...
    // Reject absurdly large payloads (1 MB).
